...
in the output. This takes priority over the heuristics below, which only
apply to words with no line_id (lyrics lookup disabled/failed) or as a
safety net for a single reference line that's implausibly long.
